...
def wrist_r_callback(msg):
 ...
 # Initialize joint objects here
def listener():

    sub_clavicle_r = rospy.Subscriber('/j1r', Float32MultiArray, clavicle_r_callback)
    sub_upper_r = rospy.Subscriber('/j2r', Float32MultiArray, upper_r_callback)
    sub_lower_r = rospy.Subscriber('/j4r', Float32MultiArray, lower_r_callback) # skips 7?
