...
{
    public class LowerRightArmController : UnitySubscriber<MessageTypes.Geometry.Pose>
    {
        ...
        protected override void Start()
        {
           lower_right_arm.gameObject.transform.localPosition
            ...
            lower_right_arm.gameObject.transform.rotation
                = GameObject.FindGameObjectWithTag("low_arm_r").transform.rotation;
