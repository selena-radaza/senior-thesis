...
{
    public class YShoulderArrowController : UnitySubscriber<MessageTypes.Geometry.Pose>
    {
        ...
        protected override void Start()
        {
            ...
            arrow.gameObject.transform.rotation
                = GameObject.FindGameObjectWithTag("up_arm_r").transform.rotation * Quaternion.Euler(-90f, 0, 0);
        }
